...
Recently I have applied the heuristic function to further help the pruning progress. It has a great effect on the performance of the AI. The running time has been reduced to the round 10% of the previous version.